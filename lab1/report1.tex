...
\begin{itemize}
  \item Το σύστημα \en P\gr:    \[\text{\en P=\gr} 4 \text{ \en (static-gain)\gr} \]
  \item Το σύστημα \en PI\gr:   \[ \text{\en PI=\gr} \frac{3.6s+0.5796}{s} \text{ \en(continuous time t.f.)\gr} \]
  \item Το σύστημα \en PID\gr:  \[\text{\en PID=\gr} \frac{4.209s^2+4.8s+1.314}{s} \text{ \en(continuous time t.f.)\gr} \]
\end{itemize}


Είναι εμφανές ότι το σύστημα \en P \gr έχει σταθερό κέρδος, ενώ το σύστημα \en PI \gr περιγράφεται από πρωτοβάθμια, και τo \en PID \gr από δευτεροβάθμια συνάρτηση μεταφοράς.
